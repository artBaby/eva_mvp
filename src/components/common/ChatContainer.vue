    ...
    export default {
        ...
        data() {
            return {
                ...
                removeUsers: [],
                menuActions: [
                    {name: 'inviteUser', title: 'Создать пользователя'},
                    {name: 'removeUser', title: 'Удалить пользователя (не удалять)'},
                    {name: 'deleteRoom', title: 'Удалить Комнату (не удалять)'}
                ],
                styles: {container: {borderRadius: '4px'}},
                textMessages: {
                    NEW_MESSAGES: 'Новые сообщения',
                    MESSAGE_DELETED: 'Сообщение удалено',
                    MESSAGES_EMPTY: 'Пустое сообщение',
